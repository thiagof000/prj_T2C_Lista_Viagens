...
class Bot(WebBot):
    ...
    def action(self, execution=None):
        ...
        var_clssSendEmail = T2CSendEmail(arg_strEmailServerSmtp="smtp-mail.outlook.com", arg_intEmailPortaSmtp="587", arg_strUsuario="thiago.sampaio@t2cgroup.com.br", arg_strSenha="teste123",arg_strNomeProcesso=var_strNomeProcesso, arg_clssMaestro=var_clssMaestro)
